/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e568dba91d598aa550c5086e0e37c638)
// Runtime types generated with workerd@1.20250422.0 2025-04-22 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		TOOLS_REGISTRY: string;
		AgentDurableObject: DurableObjectNamespace<import("./src/index").SimplePromptAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER" | "ANTHROPIC_API_KEY" | "OPEN_AI_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_AI_GATEWAY_ID" | "TOOLS_REGISTRY">> {}
}
