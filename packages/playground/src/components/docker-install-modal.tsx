...
export function DockerInstallModal({
  ...
  const [connectionStatus, setConnectionStatus] = useState<
    "idle" | "checking" | "connected" | "failed" | "timeout"
  >("idle");
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setDockerCommand(
        `docker run -d -p 11990:11990 --name mcp-toolbox -e PROXY_ID=${finalProxyId} ghcr.io/null-shot/typescript-agent-framework/mcp-toolbox:pr-50`
      );
    }
        ...
        {reason === "mismatch" && (
          <div className="w-full" style={{ padding: "0 32px 16px" }}>
            ...
            >
              ...
              >
                <strong>ProxyId Mismatch Detected:</strong> Your local server is
                running with a different ProxyId than expected. Please restart
                your Docker container with the correct ProxyId shown below to
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    >
                      Docker Desktop is required to run the MCP toolbox
                      container locally
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    Click the button below to visit the official Docker
                    installation page and download Docker Desktop for your
                    operating system.
                  </p>
                  ...
                  <div className="flex items-center gap-4">
                    <Button
                      ...
                      style={{
                        background:
                          "linear-gradient(90deg, #7849EF 0%, #326CD8 100%)",
                        fontFamily: "Space Grotesk",
                        fontWeight: 600,
                      }}
                    >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    >
                      {connectionStatus === "checking" &&
                        `Attempt ${connectionAttempts} - Waiting for Docker container to start...`}
                      {connectionStatus === "connected" &&
                        "Your local MCP toolbox is now running and ready to use"}
                      {connectionStatus === "failed" &&
                        "Please check that Docker is running and try again"}
                      {connectionStatus === "timeout" &&
                        "The container may still be starting up. You can wait or try again."}
                      {connectionStatus === "idle" &&
                        "Establishing connection to the toolbox"}
                    </p>
                  </div>
                </div>
                  ...
                  {connectionStatus === "checking" && (
                    <div className="flex items-center gap-3 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                      ...
                      <div>
                        ...
                        >
                          This may take a few moments while Docker starts the
                          container
                        </p>
                      </div>
                    </div>
                  ...
                  {connectionStatus === "timeout" && (
                    <div className="flex items-center gap-3 p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                      ...
                      <div className="flex-1">
                        ...
                        >
                          The Docker container may still be starting. You can
                          wait or retry.
                        </p>
                      </div>
                  ...
                  {connectionStatus === "failed" && (
                    <div className="flex items-center gap-3 p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                      ...
                      <div className="flex-1">
                        ...
                        >
                          Please check that Docker is running and the command
