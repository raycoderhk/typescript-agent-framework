/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 02d6706d9693c2c3cd9307d795d32b65)
// Runtime types generated with workerd@1.20250617.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		MCP_SERVER_PROXY: DurableObjectNamespace /* McpServerProxyDO from mcp-proxy */;
		ASSETS: Fetcher;
	}
}
