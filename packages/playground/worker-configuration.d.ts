/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 934355b0654336e7bde2f878e8887eb3)
// Runtime types generated with workerd@1.20250424.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		MCP_PROXY_URL: string;
		MCP_SERVER_PROXY: DurableObjectNamespace /* McpServerProxyDO from mcp-proxy-example */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "MCP_PROXY_URL">> {}
}
